...
const variantIconGradients: Record<string, string> = {
  notice: 'linear-gradient(-74deg, rgba(155,93,255,1) 0%, rgba(48,51,93,1) 100%)',
  warning: 'linear-gradient(-74deg, rgba(255,160,0,1) 0%, rgba(48,51,93,1) 100%)',
  error: 'linear-gradient(-74deg, rgba(200,71,71,1) 0%, rgba(48,51,93,1) 100%)',
  info: 'linear-gradient(-74deg, rgba(48,116,243,1) 0%, rgba(48,51,93,1) 100%)',
};

const variantButtonGradients: Record<string, string> = {
  ...
  error: 'linear-gradient(-82deg, rgba(200,71,71,1) 0%, rgba(48,51,93,1) 100%)',
  info: 'linear-gradient(-82deg, rgba(48,116,243,1) 0%, rgba(48,51,93,1) 100%)',
};

const variantCancelColors: Record<string, string> = {
  notice: 'var(--color-purple-purple, #9B5DFF)',
  warning: 'var(--color-orange-orange-warning, #FFA000)',
  error: 'var(--color-red-red-error, #C84747)',
  info: 'var(--color-blue-blue, #3074F3)',
};
...
const Dialog = React.forwardRef<HTMLDivElement, DialogProps>((
  ...
  const iconGradient = variantIconGradients[variant] ?? variantIconGradients.notice;
  const buttonGradient = variantButtonGradients[variant] ?? variantButtonGradients.notice;
  const cancelColor = variantCancelColors[variant] ?? variantCancelColors.notice;
