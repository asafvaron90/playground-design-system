...
const getVariantIconBackground = (variant: DialogProps['variant']): string => {
  switch (variant) {
    case 'warning':
      return 'linear-gradient(-74deg, #FFA000 0%, #30335D 100%)';
    case 'error':
      return 'linear-gradient(-74deg, #C84747 0%, #30335D 100%)';
    case 'info':
      return 'linear-gradient(-74deg, #3074F3 0%, #30335D 100%)';
    case 'notice':
    default:
...
const getVariantConfirmGradient = (variant: DialogProps['variant']): string => {
  switch (variant) {
    case 'warning':
      return 'linear-gradient(-82deg, #B87000 0%, rgba(48,51,93,1) 100%)';
    case 'error':
      return 'linear-gradient(-82deg, #8B2020 0%, rgba(48,51,93,1) 100%)';
    case 'info':
      return 'linear-gradient(-82deg, #1A4FAD 0%, rgba(48,51,93,1) 100%)';
    case 'notice':
    default:
...
const Dialog = React.forwardRef<HTMLDivElement, DialogProps>((
  ...
  const confirmGradient = getVariantConfirmGradient(variant);
