...
const ACCENT_COLORS: Record<TabVariant, string> = {
  Home: '#9B5DFF',
  Meetings: '#FF4FCE',
  Actions: '#AAFF00',
...
const Tab = React.forwardRef<HTMLDivElement, TabProps>(function Tab(
  ...
  const effectiveActive: TabVariant = activeTab || variant || 'Home';
  ...
  const getHomeIconColor = () =>
    effectiveActive === 'Home' ? ACCENT_COLORS.Home : INACTIVE_COLOR;
  const getMeetingsIconColor = () =>
    effectiveActive === 'Meetings' ? ACCENT_COLORS.Meetings : INACTIVE_COLOR;
  const getActionsIconColor = () =>
    effectiveActive === 'Actions' ? ACCENT_COLORS.Actions : INACTIVE_COLOR;
  const getNotificationsIconColor = () =>
    effectiveActive === 'Notifications' ? ACCENT_COLORS.Notifications : INACTIVE_COLOR;

  const getLabelWeight = (tab: TabVariant) =>
    effectiveActive === tab ? 600 : 400;
  ...
  return (
    ...
    >
      ...
      {/* Main container Frame 2147225046 */}
      <MuiBox
        sx={{
          position: 'absolute',
          left: '-2px',
      ...
      {/* Tab items layer — Frame 2147225558 */}
      <MuiBox
        sx={{
          position: 'absolute',
          left: '-2px',
      ...
      >
        ...
        >
          <MuiBox sx={{ width: '20px', height: '19px', minHeight: '19px', display: 'flex', alignItems: 'flex-start', justifyContent: 'flex-start', flexShrink: 0 }}>
            <HomeIconActive color={getHomeIconColor()} />
          </MuiBox>
          {showLabel !== false && (
            <MuiTypography
              sx={{
        ...
        >
          <MuiBox sx={{ width: '19px', height: '19px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <MeetingsIcon color={getMeetingsIconColor()} />
          </MuiBox>
          {showLabel !== false && (
            <MuiTypography
              sx={{
        ...
        >
          <MuiBox sx={{ width: '14px', height: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <ActionsIcon color={getActionsIconColor()} />
          </MuiBox>
          {showLabel !== false && (
            <MuiTypography
              sx={{
        ...
        >
          <MuiBox sx={{ width: '17px', height: '19px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <NotificationsIcon color={getNotificationsIconColor()} />
          </MuiBox>
          {showLabel !== false && (
            <MuiTypography
              sx={{
