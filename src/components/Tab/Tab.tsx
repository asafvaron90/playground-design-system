...
const TAB_ACCENT_COLORS: Record<TabVariant, string> = {
  ...
  Meetings: '#FF4EC7',
  Actions: '#AADD00',
  Notifications: '#FF4B4B',
};

const MUTED_COLOR = 'rgba(255,255,255,0.6)';
const ACTIVE_LABEL_COLOR = 'rgba(255, 255, 255, 1)';
...
const Tab = React.forwardRef<HTMLDivElement, TabProps>(function Tab(
  ...
  const handleTabClick = (tab: TabVariant) => {
  ...
  const getIconColor = (tab: TabVariant) =>
    currentActive === tab ? TAB_ACCENT_COLORS[tab] : MUTED_COLOR;

  const getLabelWeight = (tab: TabVariant) =>
    currentActive === tab ? 600 : 400;

  const getLabelColor = (tab: TabVariant) =>
    currentActive === tab ? ACTIVE_LABEL_COLOR : MUTED_COLOR;
  ...
  return (
    <MuiBox
      ...
      sx={{
        ...
        position: 'relative',
        overflow: 'hidden',
        background: 'linear-gradient(180deg, rgba(5,19,33,1) 0%, rgba(9,28,42,0.95) 50%, rgba(10,30,45,0.9) 100%)',
    ...
    >
      ...
      >
        ...
        >
          <MuiBox sx={{ width: '20px', height: '19px', minHeight: '19px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <HomeIconActive color={getIconColor('Home')} />
          </MuiBox>
          {showLabel !== false && (
            <MuiTypography
              sx={{
        ...
        >
          <MuiBox sx={{ width: '19px', height: '19px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <MeetingsIcon color={getIconColor('Meetings')} />
          </MuiBox>
          {showLabel !== false && (
            <MuiTypography
              sx={{
        ...
        >
          <MuiBox sx={{ width: '14px', height: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <ActionsIcon color={getIconColor('Actions')} />
          </MuiBox>
          {showLabel !== false && (
            <MuiTypography
              sx={{
        ...
        >
          <MuiBox sx={{ width: '17px', height: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <NotificationsIcon color={getIconColor('Notifications')} />
          </MuiBox>
          {showLabel !== false && (
            <MuiTypography
              sx={{
