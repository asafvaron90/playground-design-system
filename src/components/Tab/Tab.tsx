...
const Tab = React.forwardRef<HTMLDivElement, TabProps>(({
  ...
  const baseStyles = {
    ...
    fontSize: 'var(--font-label-sml-size, 12px)',
    fontFamily: 'var(--font-label-sml-family, Inter)',
    fontWeight: 'var(--font-label-sml-weight, 400)',
    position: 'relative',
    overflow: 'hidden',
  ...
  const variantStyles = {
    Home: {
      borderTopLeftRadius: 'var(--radius-medium, 8px)',
      borderTopRightRadius: 'var(--radius-medium, 8px)',
      borderBottomLeftRadius: 'var(--radius-medium, 8px)',
      borderBottomRightRadius: 'var(--radius-medium, 8px)',
    },
    Meetings: {},
    Actions: {},
    Notifications: {},
