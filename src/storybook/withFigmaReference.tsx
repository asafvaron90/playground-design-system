    ...
    >
      ...
      >
        <div style={{ flex: '0 0 auto' }}>
          ...
          {/* data-figma-component marks the implementation panel so the
              visual-gate CLI screenshots ONLY the component (not the reference
              image) and pixel-diffs it against the Figma reference PNG. */}
          <div data-figma-component>
            <Story {...context} />
          </div>
        </div>
